...
- Key features of Constructor Injector and why it's recommended
	...
	- **Type safety (fail safety & fail fast) - ** Constrcutor injection forced to required all neceesary bean, If it missed the application fail fast. But, field injection initial call empty constructor. So, no garaentee  
